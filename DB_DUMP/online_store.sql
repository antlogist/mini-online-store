...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=396049254ltr&server=1">
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"ru",server:"1",table:"",db:"",token:"7924223c3b5a38293f2d5b4f787c4f5a",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Обзор",pma_text_left_default_tab:"Структура",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"cookie",user:"root"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=orders">`online_store`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=products">`online_store`.`products`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7924223c3b5a38293f2d5b4f787c4f5a">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap" href="index.php?route=/server/binlog">
              <img src="themes/dot.gif" title="Бинарный журнал" alt="Бинарный журнал" class="icon ic_s_tbl">&nbsp;Бинарный журнал
                          </a>
          </li>
                  <li class="nav-item">
